...
export default function SkewedAutomationGraph() {
    ...
    return (
        ...
        <div className="relative w-screen h-screen flex items-center justify-start bg-black overflow-hidden">
            {/* Outer container: visible on md+ screens only */}
            <div className="hidden md:block">
                {/* Graph Wrapper: fixed size */}
                <div
                    className="relative"
                    style={{
                        width: '1150px',
                ...
                >
                    {/* Skewed and rotated container for both grid and nodes */}
                    <div
